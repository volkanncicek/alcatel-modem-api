...
def main():
  ...
  parser.add_argument("-u", "--url", default=os.getenv("MODEM_URL", "http://192.168.1.1"), help="Modem URL (default: http://192.168.1.1 or MODEM_URL env)")
  parser.add_argument("-p", "--password", default=os.getenv("MODEM_PASSWORD"), help="Admin password (or MODEM_PASSWORD env)")
  parser.add_argument("--port", type=int, default=int(os.getenv("EXPORTER_PORT", "8080")), help="Exporter port (default: 8080 or EXPORTER_PORT env)")
  parser.add_argument(
    "--interval", type=int, default=int(os.getenv("UPDATE_INTERVAL", "10")), help="Update interval in seconds (default: 10 or UPDATE_INTERVAL env)"
  )
  parser.add_argument(
    "--log-level",
